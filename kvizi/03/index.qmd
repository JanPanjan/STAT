...
Vaša naloga bo narediti več statističnih analiz. Vsaka statistična analiza naj vključuje:
- eksplicitno zapisani ničelno in alternativno hipotezo,
- utemeljitev uporabe izbranega statističnega testa,
- izračun z R,
- statistični sklep
- in vsebinski sklep.
...
***Pri $\alpha = 0.01$ preverite ali se številka čevlja razlikuje pri študentih in
študentkah.***
...
Visoka $p$ vrednost nakazuje na to, da odstopanja niso statistično značilna - $H_0$ obdrđimo.
Velikost čevlja se med študenti in študentkami razlikuje.

## Naloga 2

***Predstavite podatke za številko čevlja in težo z ustreznim grafom. Preverite
ali je številka čevlja linearno odvisna od teže v populaciji študentov. Interpretirajte
rezultate. Komentirajte ali je predstavljen problem smiselno zastavljen.***
...
Korelacija $\approx$ 0.695 je nadpovprečna, zato lahko trdim, da sta teža in velikost noge
linearno korelirani. Podobno je razvidno iz spodnjega grafa. Hipotezo $H_0$ zavržemo v prid
alternativne domneve $H_1$.
...
***Preverite ali sta Teža in število ur športa na teden monotono povezani slučajni
spremenljivki v populaciji.***
...
***Preverite ali je zastopanost domačih ljubljenčkov v populaciji študentov
različna od: pes 41%, mačka 33%, riba 10%, drugo 16%.***
